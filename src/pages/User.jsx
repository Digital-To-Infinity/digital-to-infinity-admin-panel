...
const usersData = [
  ...
  { id: 2, name: 'Sandeep Patil', email: 'sandeep@example.com', role: 'User', status: 'Active', joinDate: '2025-02-15' },
  { id: 3, name: 'Meera Deshmukh', email: 'meera@example.com', role: 'User', status: 'Inactive', joinDate: '2025-03-01' },
  { id: 4, name: 'Prashant More', email: 'prashant@example.com', role: 'User', status: 'Active', joinDate: '2025-03-20' },
  { id: 5, name: 'Sneha Pawar', email: 'sneha@example.com', role: 'User', status: 'Active', joinDate: '2025-02-28' },
  { id: 6, name: 'Aditya Kulkarni', email: 'aditya@example.com', role: 'Admin', status: 'Active', joinDate: '2025-01-10' },
  { id: 7, name: 'Sandeep Patil', email: 'sandeep@example.com', role: 'User', status: 'Active', joinDate: '2025-02-15' },
  { id: 8, name: 'Meera Deshmukh', email: 'meera@example.com', role: 'User', status: 'Inactive', joinDate: '2025-03-01' },
  { id: 9, name: 'Prashant More', email: 'prashant@example.com', role: 'User', status: 'Active', joinDate: '2025-03-20' },
  { id: 10, name: 'Sneha Pawar', email: 'sneha@example.com', role: 'User', status: 'Active', joinDate: '2025-02-28' },
];
