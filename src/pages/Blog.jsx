...
const blogsData = [
  { id: 1, title: 'The Future of AI in Digital Marketing: 2026 Trends', category: 'Technology', status: 'Published', date: '2026-03-22', views: 1240, featured: true },
  { id: 2, title: 'How to Build a High-Converting Landing Page', category: 'Design', status: 'Draft', date: '2026-03-21', views: 0, featured: false },
  { id: 3, title: 'Mastering SEO: A Comprehensive Guide for Beginners', category: 'SEO', status: 'Published', date: '2026-03-20', views: 890, featured: false },
  { id: 4, title: 'Digital Transformation: Why Every Business Needs it', category: 'Business', status: 'Published', date: '2026-03-19', views: 3420, featured: true },
  { id: 5, title: 'Top 10 Tools for Content Creators in 2026', category: 'Marketing', status: 'Published', date: '2026-03-15', views: 1560, featured: false },
  { id: 6, title: 'Understanding Blockchain and Web3 for Business', category: 'Technology', status: 'Draft', date: '2026-03-10', views: 0, featured: false },
  { id: 7, title: 'Social Media Marketing Strategies that Work', category: 'Marketing', status: 'Published', date: '2026-03-05', views: 2100, featured: false },
  { id: 8, title: 'UX/UI Principles for Better Engagement', category: 'Design', status: 'Published', date: '2026-03-01', views: 4500, featured: true },
  { id: 9, title: 'Cybersecurity for Small Businesses in 2026', category: 'Security', status: 'Published', date: '2026-02-25', views: 1100, featured: false },
  { id: 10, title: 'Email Marketing: Is it Still Relevant?', category: 'Marketing', status: 'Published', date: '2026-02-20', views: 950, featured: false },
];
...
const Blog = () => {
  ...
  const handleShare = (id) => {
    const blogLink = `https://digitaltoinfinity.com/blog/${id}`;
    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="flex flex-col min-[427px]:flex-row min-[427px]:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 hidden sm:block">Create and manage content for Digital to Infinity platform.</p>
        </div>
        <NavLink
