        ...
        >
            ...
            <div className="space-y-8">
                ...
                <div className="relative group">
                    ...
                    />
                    <div className="border-4 border-dashed border-zinc-100 rounded-[32px] p-12 max-[426px]:p-6 text-center group-hover:border-primary/30 group-hover:bg-primary/5 transition-all">
                        <div className="w-20 h-20 bg-zinc-100 rounded-full flex items-center justify-center mx-auto mb-6 text-zinc-300 group-hover:scale-110 group-hover:bg-white group-hover:text-primary transition-all shadow-sm">
                ...
                {previews.length > 0 && (
                    <Reorder.Group 
                        axis="x" // Changed to x or both since it's a grid, but x is often used for multi-column. Actually y works for vertical reorder. Grid usually needs some trickery or a different component. Reorder.Group usually handles lists.
                        values={previews} 
                        ...
                        <AnimatePresence>
                            {previews.map((src, index) => (
                                ...
                                >
                                    ...
                                    {/* Cover Badge */}
                                    {index === 0 && (
                                        <div className="absolute top-2 left-2 px-2 py-1 bg-primary text-white text-[9px] font-black uppercase rounded-lg shadow-sm flex items-center gap-1 z-20">
